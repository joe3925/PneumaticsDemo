...
public class RobotContainer {
  ...
  private DoubleSolenoidSubsystem m_doubleSolenoid = DoubleSolenoidSubsystem.getInstance();
  private CompressorSubsystem m_CompressorSubsystem = PneumaticFactory.getCompressorSubsystem();
  ...
  public RobotContainer() {
    m_CompressorSubsystem.enable().execute();
